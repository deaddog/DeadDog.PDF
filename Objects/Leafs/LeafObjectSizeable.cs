...
{
    /// <summary>
    /// Implements basic functionalities for sizeable leaf objects. <see cref="LeafObject"/> and <see cref="LeafObjectSizeable"/> are the only objects that can actually be drawn.
    /// </summary>
    public abstract class LeafObjectSizeable : PDFObjectSizeable
    {
        internal LeafObjectSizeable()
        {
        }
        ...
        /// <summary>
        /// Adds this <see cref="LeafObjectSizeable"/> to an object collector.
        /// </summary>
        /// <param name="collector">An <see cref="ObjectCollector"/> to which this <see cref="LeafObjectSizeable"/> is added.</param>
